...
public GUIPrincipal(Controller c) {
	...
	FileButton.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent arg0) {
			JFileChooser ficheroEntrada = new JFileChooser();
	...
	btnNewButton.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent arg0) {
			JFileChooser ficheroEjemploC = new JFileChooser();
	...
	EjecutarButton.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent arg0) {
			if(fichero==null) {
				JOptionPane.showMessageDialog(null, "inserta un fichero de entrada", "File error", JOptionPane.ERROR_MESSAGE);
			}
			else if(ficheroEjemplo==null) {
				JOptionPane.showMessageDialog(null, "inserta un fichero de ejemplo", "File error", JOptionPane.ERROR_MESSAGE);
			}else {
